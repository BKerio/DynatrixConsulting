  ...
  return (
    <div ref={sectionRef}>
      <PageHero
        ...
        description="Ready to transform your business? Reach out to our team and let's discuss how we can help you achieve your technology goals."
      />
                ...
                {submitted ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <select value={formData.service} onChange={(e) => setFormData({ ...formData, service: e.target.value })} className={inputClass}>
                      ...
                      <option value="erp">ERP & Systems Integration</option>
