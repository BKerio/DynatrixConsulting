...
export default function About() {
  ...
  return (
    <div ref={sectionRef}>
          ...
          <div className="mission-grid grid md:grid-cols-2 gap-12 lg:gap-20 items-stretch">
            ...
            <div className="mission-card flex flex-col justify-between h-full">
              ...
              <div className="mt-8 lg:mt-12 flex-1 flex flex-col justify-end">
                <h2 className="text-3xl sm:text-4xl font-bold text-[#ED7D31] tracking-tight mb-4">Mission</h2>
            ...
            <div className="mission-card flex flex-col justify-between h-full mt-12 md:mt-0">
              <div className="mb-8 lg:mb-12 flex-1 flex flex-col justify-start">
                <h2 className="text-3xl sm:text-4xl font-bold text-[#ED7D31] tracking-tight mb-4">Vision</h2>
                <p className="text-[16px] sm:text-[18px] leading-[32px] text-[#3c3f44] font-normal">
                  {companyInfo.vision}
                </p>
              </div>
      ...
      <section 
        className="relative py-24 px-4 sm:px-6 lg:px-8 border-y-[12px] border-[#fec63f] bg-cover bg-center overflow-hidden"
      ...
      >
        ...
        <div className="container-custom relative z-10">
          <h2 className="text-3xl sm:text-4xl lg:text-[45px] font-bold text-center text-[#ED7D31] tracking-tight mb-16">
            Core Values
          </h2>
            ...
            <div className="flex flex-col gap-6 sm:gap-8">
              {visualValues.slice(0, 3).map((item) => (
                <div key={item.num} className="values-card flex items-center gap-3 sm:gap-4 max-w-[520px] mx-auto w-full group">
                  <div className="w-12 h-12 rounded-full bg-[#fec63f] flex items-center justify-center font-extrabold text-charcoal text-lg shadow-md shrink-0 transition-transform duration-300 group-hover:scale-110">
                    {item.num}
                  </div>
                  <div className="bg-[#008DA5] border border-white/10 rounded-[32px] px-6 py-4 flex-1 text-center shadow-lg transition-all duration-300 group-hover:bg-[#009ebc] group-hover:shadow-xl">
                    <h3 className="text-[15px] sm:text-[16px] font-bold text-[#fec63f] uppercase tracking-wider mb-1">
                      {item.title}
                    </h3>
