        ...
        <div className="grid lg:grid-cols-12 gap-12 items-start">
          <div className="lg:col-span-4">
            <SectionTitle
              ...
              description="Trusted by leading organizations across Africa for delivering excellence in IT consulting and digital transformation."
              className="mb-0"
            />
          ...
          <div className="lg:col-span-8 testimonial-panel">
            <div className="testimonial-card-dark">
              ...
              <div className="flex items-center gap-4 pt-6 border-t border-white/10">
                <div className="w-16 h-16 rounded-full overflow-hidden border-2 border-golden flex-shrink-0">
                  <img src={active.image} alt={active.author} className="w-full h-full object-cover" />
                </div>
                <div>
