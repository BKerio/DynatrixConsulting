        ...
        <div className="flex flex-col gap-5 w-full">
          <div className="grid grid-cols-4 gap-2 text-center">
            <div className="text-left flex flex-col justify-end">
              <span className="text-[10px] font-bold text-[#ED7D31] tracking-wide leading-tight italic">Project Kick-Off</span>
              <span className="text-sm text-[#ED7D31] font-semibold mt-1">➔</span>
            </div>
            {[1, 2, 3].map((i) => (
              <div key={i} className="flex flex-col items-center justify-end">
                ...
                <span className="text-xs text-[#ED7D31] font-extrabold mt-1">▲</span>
              </div>
            ))}
          </div>
          ...
          <div className="grid grid-cols-4 gap-2 text-center items-center bg-[#e6f7f8] rounded-xl py-2 px-1 border border-[#bbf7f0]/30">
            ...
            {[1, 2, 3].map((i) => (
              <div key={i} className={`flex justify-center ${i < 3 ? 'border-r border-dashed border-charcoal/10' : ''}`}>
                <Rocket className="w-4 h-4 text-[#ED7D31]" />
              </div>
            ))}
          </div>
        </div>
