...
export const partners = [
  'Microsoft', 'Cisco', 'Fortinet', 'Odoo', 'Sage', 'AWS',
  'Huawei', 'Zoho', 'Check Point', 'Forcepoint', 'eBoard',
  'EazzyRent', 'Wingubox', 'Xero', 'SeamlessHR',
];

export const clients = [
  { name: 'Bolba SACCO', industry: 'Financial Services' },
  { name: 'AAR Hospital', industry: 'Healthcare' },
  { name: 'RBA', industry: 'Government' },
  { name: 'Steel & Tube', industry: 'Manufacturing' },
  { name: 'Tropekal Brands', industry: 'Consumer Goods' },
  { name: 'Basis', industry: 'Technology' },
  { name: 'QORA', industry: 'Fintech' },
  { name: 'DASA', industry: 'Logistics' },
  { name: 'Rolling Cargo', industry: 'Transportation' },
  { name: 'Cake City', industry: 'Retail' },
];
